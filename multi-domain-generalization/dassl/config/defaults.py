...
_C.TRAINER.CONSTSTYLE.STYLE_GENERATOR = "A3"
_C.TRAINER.CONSTSTYLE.STYLE_ALIGNMENT = "B0"
_C.TRAINER.CONSTSTYLE.B1_ALPHA = 0.5
_C.TRAINER.CONSTSTYLE.DSU_FACTOR = 0.5
_C.TRAINER.CONSTSTYLE.TRID_FACTOR = 1.0
_C.TRAINER.CONSTSTYLE.FLOW_N_FLOWS = 4
_C.TRAINER.CONSTSTYLE.FLOW_CLAMP_VALUE = 2.0
_C.TRAINER.CONSTSTYLE.FLOW_TEMP = 1.0
_C.TRAINER.CONSTSTYLE.FLOW_NORMALIZE_INPUT = False